-- APPLIED TO PRODUCTION on 2026-07-23 — the canonical, versioned copy of
-- this migration now lives at
-- supabase/migrations/20260723103525_parasut_full_apidocs_schema_expansion.sql
-- (that file is the source of truth going forward; this proposal copy is
-- kept for historical context and is identical to what was applied).
--
...
-- into supabase/migrations/ once explicitly approved and applied, which has
-- now happened.
--
