...
-- supabase/migrations/ — see the existing convention in this same directory
-- (assign_erp_company_id.sql, 20260716090000_move_sync_tables_to_parasut_schema.sql,
-- 20260716120000_erp_outbound_commands.sql). Only move (copy) this file into
-- supabase/migrations/ once explicitly approved.
--
