...
import { salesQuotes } from "../sales/salesData";
import { printQuote } from "../sales/salesUtils";
  ...
  if (!customer) {
    return (
      <div className="crm-page">
        <CrmPageHeader current="Müşteri bulunamadı" title="Müşteri bulunamadı" subtitle={`"${customerId}" kimlikli müşteri kaydı bulunamadı.`}>
    ...
    <div className="crm-page">
      ...
      <section className="crm-account">
        <div className="crm-detail-grid">
          ...
          <article className="erp-card crm-payment-chart">
