    ...
    <div className="finance-overview">
      <header className="finance-page-heading">
        ...
        <div className="finance-heading-actions">
          <Link to="/apps/finance/income/invoices/new">＋ Tahsilat Ekle</Link>
          <Link to="/apps/finance/expense/list/new/invoice">− Ödeme Ekle</Link>
        ...
        <aside className="ebru-card finance-timeline-panel">
          ...
          <div className="finance-timeline">
            {financeOverviewData.timeline.length ? (
              ...
              <div className="finance-timeline-item upcoming">
                <i />
                <small>Planlanmış kayıt yok</small>
                <strong>—</strong>
              </div>
            )}
          </div>
