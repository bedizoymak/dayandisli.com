...
export default function EbruRouteContent({ routePath }: { routePath: string }) {
  ...
  if (routePath.endsWith("/hr") || routePath.endsWith("/hr/employees")) {
    return <CanonicalParasutListPage config={canonicalParasutPages.employees} />;
  }
  if (routePath.endsWith("/hr/salaries")) {
    return <CanonicalParasutListPage config={canonicalParasutPages.salaries} />;
  }
  if (
    routePath.endsWith("/e-documents") ||
    routePath.endsWith("/e-documents/invoices")
  ) {
    return <CanonicalParasutListPage config={canonicalParasutPages.eInvoices} />;
  }
  ...
  if (routePath.endsWith("/reports/production")) return <ProductionReportPage />;
  ...
  // parasut.sales_offers is the live mirror table for quotes; parasut-api already serves it (canonicalParasutPages.offers).
  if (routePath.endsWith("/sales/quotes")) return <CanonicalParasutListPage config={canonicalParasutPages.offers} />;
  ...
  // parasut.contacts (account_type=customer) is the live source; same config/resource as Finance > Income > Customers.
  if (routePath.endsWith("/crm/customers")) return <CanonicalParasutListPage config={canonicalParasutPages.customers} />;
  if (routePath.endsWith("/finance/income/invoices/new")) return <SalesInvoiceForm />;
  if (routePath.endsWith("/finance/income/invoices")) return <CanonicalParasutListPage config={canonicalParasutPages.invoices} />;
  if (routePath.endsWith("/finance/income/customers/new")) return <CustomerFormPage />;
  if (routePath.endsWith("/finance/income/customers")) return <CanonicalParasutListPage config={canonicalParasutPages.customers} />;
  ...
  if (routePath.endsWith("/finance/expense/list")) return <CanonicalParasutListPage config={canonicalParasutPages.expenses} />;
  if (routePath.endsWith("/finance/expense/incoming-invoices")) return <CanonicalParasutListPage config={canonicalParasutPages.purchaseBills} />;
  ...
  if (routePath.endsWith("/finance/inventory/products")) return <CanonicalParasutListPage config={canonicalParasutPages.products} />;
  ...
  if (routePath.endsWith("/finance/inventory/outgoing-dispatches")) return <CanonicalParasutListPage config={canonicalParasutPages.shipments} />;
  if (routePath.endsWith("/finance/inventory/incoming-dispatches")) return <CanonicalParasutListPage config={canonicalParasutPages.shipments} />;
  if (routePath.endsWith("/finance/inventory/history")) return <CanonicalParasutListPage config={canonicalParasutPages.stockHistory} />;
  if (routePath.endsWith("/finance/inventory/report")) return <CanonicalParasutListPage config={canonicalParasutPages.inventory} />;
  if (routePath.endsWith("/finance/purchasing/suppliers/new")) return <SupplierFormPage />;
  if (routePath.endsWith("/finance/purchasing/suppliers")) return <CanonicalParasutListPage config={canonicalParasutPages.suppliers} />;
  ...
  if (routePath.endsWith("/finance/cash/accounts")) return <CanonicalParasutListPage config={canonicalParasutPages.accounts} />;
