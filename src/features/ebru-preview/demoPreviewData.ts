// Isolated visual-review fixtures. This module is consumed only when
// EbruPreviewPage is mounted with demoMode at /apps/demo.
export const demoDashboard = {
  ...
  notifications: [
    { title: "Yeni tahsilat kaydı", description: "Ödeme plana eklendi.", relativeTime: "12 dk önce" },
    { title: "İş emri güncellendi", description: "Üretim aşamasına geçti.", relativeTime: "38 dk önce" },
    { title: "Onay bekleniyor", description: "İki masraf kaydı incelemenizi bekliyor.", relativeTime: "1 sa önce" },
  ],
  calendar: { 3: "Tahsilat", 7: "Ödeme", 12: "Tahsilat", 17: "Tahsilat", 18: "Ödeme", 21: "Tahsilat", 25: "Personel" } as Record<number, string>,
};
