...
export function adaptQuoteToPdf(quote: SalesQuote): QuotePdfDocument {
  ...
  return {
    ...
    validity: quote.optionValidity || quote.validUntil || "—",
    currency: quote.currency,
    subject: quote.subject || "—",
    project: quote.project,
    issuer: {
      name: "DAYAN DİŞLİ & PROFİL TAŞLAMA",
      contact: "Hayrettin Dayan",
      phone: "+90 536 583 74 20",
      email: "info@dayandisli.com",
      website: "dayandisli.com",
      address: "İkitelli O.S.B. Çevre Sanayi Sitesi, 8. Blok No: 45/47 Başakşehir / İstanbul",
      taxNo: "—",
    },
    customer: {
