    ...
    pages: [
      {
        id: "orders",
        label: "Siparişler",
        route: "/demo/finance/purchasing/orders",
        permissionKey: "purchasing.view",
      },
      {
        id: "suppliers",
        label: "Tedarikçiler",
        route: "/demo/finance/purchasing/suppliers",
    ...
    pages: [
      {
        ...
        route: "/demo/finance/inventory/products",
        permissionKey: "inventory.view",
      },
      {
        id: "outgoing-dispatches",
        label: "Giden İrsaliyeler",
        route: "/demo/finance/inventory/outgoing-dispatches",
        permissionKey: "inventory.view",
      },
      {
        id: "incoming-dispatches",
        label: "Gelen İrsaliyeler",
        route: "/demo/finance/inventory/incoming-dispatches",
        permissionKey: "inventory.view",
      },
      {
        id: "stock-history",
        label: "Stok Geçmişi",
        route: "/demo/finance/inventory/history",
        permissionKey: "inventory.view",
      },
      {
        id: "stock-report",
        label: "Stoktaki Ürünler Raporu",
        route: "/demo/finance/inventory/report",
        permissionKey: "inventory.view",
      },
    ],
  },
