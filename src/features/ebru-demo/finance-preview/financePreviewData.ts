    ...
    pages: [
      {
        id: "invoices",
        label: "Faturalar",
        route: "/apps/demo/finance/income/invoices",
        permissionKey: "finance.income.invoices",
      },
      {
        id: "customers",
        label: "Müşteriler",
        route: "/apps/demo/finance/income/customers",
        permissionKey: "finance.income.customers",
      },
      {
        id: "collections-report",
        label: "Tahsilat Raporu",
        route: "/apps/demo/finance/income/collection-report",
    ...
    pages: [
      {
        id: "expense-list",
        label: "Gider Listesi",
        route: "/apps/demo/finance/expense/list",
        permissionKey: "finance.expense.list",
      },
      {
        id: "incoming-invoices",
        label: "Gelen Faturalar",
        route: "/apps/demo/finance/expense/incoming-invoices",
        permissionKey: "finance.expense.incoming_invoices",
      },
      {
        id: "income-expense-report",
        label: "Gelir-Gider Raporu",
        route: "/apps/demo/finance/expense/income-expense-report",
        permissionKey: "finance.reports",
      },
      {
        id: "payments-report",
        label: "Ödemeler Raporu",
        route: "/apps/demo/finance/expense/payments-report",
        permissionKey: "finance.reports",
      },
      {
        id: "vat-report",
        label: "KDV Raporu",
        route: "/apps/demo/finance/expense/vat-report",
        permissionKey: "finance.reports",
      },
    ],
  },
    ...
    pages: [
      {
        id: "orders",
        label: "Siparişler",
        route: "/apps/demo/finance/purchasing/orders",
        permissionKey: "purchasing.view",
      },
      {
        id: "suppliers",
        label: "Tedarikçiler",
        route: "/apps/demo/finance/purchasing/suppliers",
    ...
    pages: [
      {
        ...
        route: "/apps/demo/finance/cash/accounts",
        permissionKey: "finance.cash.accounts",
      },
      {
        id: "checks",
        label: "Çekler",
        route: "/apps/demo/finance/cash/checks",
        permissionKey: "finance.cash.checks",
      },
      {
        id: "cash-bank-report",
        label: "Kasa / Banka Raporu",
        route: "/apps/demo/finance/cash/cash-bank-report",
        permissionKey: "finance.cash.reports",
      },
      {
        id: "cash-flow",
        label: "Nakit Akış Raporu",
        route: "/apps/demo/finance/cash/cash-flow-report",
        permissionKey: "finance.cash.reports",
      },
    ],
  },
    ...
    pages: [
      {
        ...
        route: "/apps/demo/finance/inventory/products",
        permissionKey: "inventory.view",
      },
      {
        id: "outgoing-dispatches",
        label: "Giden İrsaliyeler",
        route: "/apps/demo/finance/inventory/outgoing-dispatches",
        permissionKey: "inventory.view",
      },
      {
        id: "incoming-dispatches",
        label: "Gelen İrsaliyeler",
        route: "/apps/demo/finance/inventory/incoming-dispatches",
        permissionKey: "inventory.view",
      },
      {
        id: "stock-history",
        label: "Stok Geçmişi",
        route: "/apps/demo/finance/inventory/history",
        permissionKey: "inventory.view",
      },
      {
        id: "stock-report",
        label: "Stoktaki Ürünler Raporu",
        route: "/apps/demo/finance/inventory/report",
        permissionKey: "inventory.view",
      },
    ],
  },
