  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        erp: {
          bg: "hsl(var(--erp-bg))",
          "bg-soft": "hsl(var(--erp-bg-soft))",
          surface: "hsl(var(--erp-surface))",
          "surface-raised": "hsl(var(--erp-surface-raised))",
          card: "hsl(var(--erp-card))",
          border: "hsl(var(--erp-border))",
          text: "hsl(var(--erp-text))",
          muted: "hsl(var(--erp-text-muted))",
          primary: "hsl(var(--erp-primary))",
          "primary-hover": "hsl(var(--erp-primary-hover))",
